...
public class RegisterActivity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                if (checkededitText()) {
                    new Registerl(edReUser.getText().toString(),
                            ...
                            eddisname.getText().toString());
                } else {
                    Toast.makeText(RegisterActivity.this, "กรอกข้อมูลให้ครบ", Toast.LENGTH_SHORT).show();
                }
    ...
    private class Registerl extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            Toast.makeText(RegisterActivity.this, "เรียบร้อยแล้วจ๊ะ", Toast.LENGTH_SHORT).show();
            try {
